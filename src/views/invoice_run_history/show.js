...
function formatUnitLabel(result) {
  ...
  const details = [unitNo, buildingName].filter(Boolean);
                  ...
                  results.map((result) => (
                    <tr key={result.id}>
                      <td style={bodyCellStyle}>
                        <span style={successBadgeStyle(result.success)}>{result.success ? "Yes" : "No"}</span>
                      </td>
                      <td style={bodyCellStyle} className="text-capitalize">{result?.error_code || "-"}</td>
                      <td style={bodyCellStyle}>{result?.error_message || "-"}</td>
                      <td style={unitBodyStyle}>{formatUnitLabel(result)}</td>
                      <td style={bodyCellStyle}>{formatAmount(result?.invoice?.amount)}</td>
                      <td style={bodyCellStyle}>{formatAmount(result?.invoice?.vat_amount)}</td>
                      <td style={bodyCellStyle}>{formatAmount(result?.invoice?.total_amount)}</td>
                    </tr>
                  ))
                ) : (
                  <tr>
